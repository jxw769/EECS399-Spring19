...
module test1a_mm_interconnect_0_router_default_decode
  #(
...
module test1a_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    test1a_mm_interconnect_0_router_default_decode the_default_decode(
